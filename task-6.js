...
const users =  [
 ...
 //---------РЕШЕНИЕ ЧЕРЕЗ ОБЫЧНУЮ ФУНКЦИЮ C ДЕСТРУКТУРИРУЮЩИМ ПРИСВАИВАНИЕМ и в конце без----------

// const getUsersWithAge = function (array, min, max) {
//     const filteredArray = array.filter(function ({ age }) {
//         return age >= min && age <= max;
//     });
//     //console.log(filteredArray);


//     return filteredArray.map(function (arr) {
//         const newObj = {
//             name: arr.name,
//             email: arr.email
//         };
